...
//! if you declare a variable in the if statement it won't be in teh global scope and you can't use it outside of the statement    
// but you can declare a variable outside of the statement and then reassign it in the statement 
