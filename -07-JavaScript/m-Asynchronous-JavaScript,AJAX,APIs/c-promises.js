...
const getCountryData = function (country) {
  // we pass a callback function in the THEN method that we want to happen when the promise is fulfilled (successful)
  ...
  fetch(`https://restcountries.com/v2/name/${country}`)
    .then(function (response) {
      ...
      // then method it self will return a promise
